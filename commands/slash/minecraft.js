    ...
    async autocomplete(client, int) {
        ...
        switch(option.name) {
            case 'render-type': {
                ...
                let matches = avaibleRenderTypes
                    .filter(renderType => renderType.value.toLowerCase().startsWith(option.value.toLowerCase()))
            ...
            case 'crop-type': {
                ...
                const matches = (avaibleCropTypes[renderType] || [])
                    ...
                    .filter(cropType => cropType.name.toLowerCase().startsWith(option.value.toLowerCase()))
