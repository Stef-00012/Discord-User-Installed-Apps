        ...
        try {
            ...
            if (typeof evaluatedCode !== 'string') {
                ...
                fields.push(
                    {
                        name: 'Output:',
                        value: cleanEvalOutput(evaluatedCode).length > 1000 ? `\`\`\`js\n${cleanEvalOutput(evaluatedCode).substr(0, 1000)}...\n\`\`\`` : `\`\`\`js\n${cleanEvalOutput(evaluatedCode)}\n\`\`\``
                    }
                )
            } else {
                fields.push(
                    {
                        name: 'Output:',
                        value: evaluatedCode.length > 1000 ? `\`\`\`js\n${evaluatedCode.substr(0, 1000)}...\n\`\`\`` : `\`\`\`js\n${evaluatedCode}\n\`\`\``
                    }
                )
            }
